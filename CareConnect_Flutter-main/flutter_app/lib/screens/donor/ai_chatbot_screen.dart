...
class _AiChatbotScreenState extends State<AiChatbotScreen> {
  ...
  Future<void> _sendMessage([String? text]) async {
    ...
    try {
      final response = await _api.chatWithAI(messageText);
      ...
      setState(() {
        ...
        _isTyping = false;
        // Reset suggestions to default since API doesn't provide them
        _suggestions = _defaultSuggestedReplies(widget.patient);
      });
    } catch (e) {
      if (!mounted) return;
      setState(() {
