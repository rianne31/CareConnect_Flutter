                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Wrap(
                          spacing: 12,
                          runSpacing: 12,
                          children: (donor['achievements'] as List).map((a) => Chip(avatar: const Icon(Icons.emoji_events, size: 16), label: Text(a.toString()), backgroundColor: Colors.amber[100])).toList(),
                        ),
                      ),
                    ),
                  ],
