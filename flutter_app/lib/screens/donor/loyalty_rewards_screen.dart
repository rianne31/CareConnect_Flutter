    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          final currentTier = donor['loyaltyTier'] ?? 'Bronze';
          final totalDonated = donor['totalDonated'] ?? 0.0;
          final loyaltyPoints = donor['loyaltyPoints'] ?? 0;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Total Donated: ${Formatters.formatCurrency(totalDonated)}',
          ...
          children: [
            ...
            LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                tierInfo[nextTier]!['color'],
              ),
              minHeight: 8,
            ),
            const SizedBox(height: 8),
            Text(
              '${Formatters.formatCurrency(totalDonated)} / ${Formatters.formatCurrency(nextTierMin.toDouble())}',
            ...
            const SizedBox(height: 4),
            Text(
              '${Formatters.formatCurrency(nextTierMin - totalDonated)} more to unlock',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'Minimum: ${Formatters.formatCurrency(tierData['minDonation'].toDouble())}',
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          color: Colors.grey[600],
                        ),
                      ),
